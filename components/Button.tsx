...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-slate-800 hover:bg-slate-900 text-white shadow-md focus:ring-slate-600",
    outline: "border-2 border-slate-200 hover:border-emerald-500 hover:text-emerald-600 text-slate-600 focus:ring-emerald-500",
